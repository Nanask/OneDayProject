...
public class ListServiceImpl implements ListService{
	...
	public ListDTO findById(String num) {
		...
		ListDTO listDTO = jdbcTemplate.queryForObject(sql, param, new BeanPropertyRowMapper<ListDTO>(ListDTO.class)); 
		
//		return jdbcTemplate.queryForObject(sql, param, new BeanPropertyRowMapper<ListDTO>(ListDTO.class));
